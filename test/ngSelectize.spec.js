describe('Tests for the ngSelectize directive', function() {
  ...
  describe('with a select-element', function() {
    ...
    describe('with ng-options', function() {
      ...
      it('should work with o.name for o in options', function() {
        var ready = false;
      ...
      it('should work with o.value as o.name for o in options', function() {
        var ready = false;
      ...
      it('should work with o as o.name for o in options', function() {
        var ready = false;
      ...
      it('should work with value as key for (key, value) in options', function() {
        var ready = false;
      ...
      it('should work with key as value for (key, value) in options', function() {
        var ready = false;
      ...
      it('should work with key for (key, value) in options', function() {
        var ready = false;
    ...
    describe('should work with multiple values', function() {
      it('should work with multiple values for o.value as o.name for o in options', function() {
        var ready = false;
